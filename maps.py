...
#load map frames
def load_map_frames(map_num, no_of_frames, extension):
    map_frames = []
...
class Map:
    def __init__(self, map_num, no_of_frames, extension, cooldown):
        self.map_frames = load_map_frames(map_num, no_of_frames, extension)
...
map1 = Map("map1", 12, ".gif", 100)
map2 = Map("map2", 10, ".gif", 87)
map3 = Map("map3", 143, ".png", 65)
map4 = Map("map4", 42, ".png", 100)